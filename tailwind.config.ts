...
const config: Config = {
  		...
  		keyframes: {
			...
			slideright: {
  			...
  			floating: {
  				...
  				'50%': {
  					transform: 'translate3d(0px, -1.43113px, 0px)',
  					opacity: '1'
  				},
  				'100%': {
  					transform: 'translate3d(0px, -4.86226px, 0px)',
  					opacity: '1'
  				}
  			},
  			fadein: {
  ...
  plugins: [tailwindcssAnimate, addVariablesForColors ,  function ({ matchUtilities, theme }: any) {
	matchUtilities(
	  {
		"bg-grid": (value: any) => ({
